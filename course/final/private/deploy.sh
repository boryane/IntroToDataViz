...
##
LIVE_BUCKET='s3://riverseeker/'
SITE_DIR='/Users/beberhard/Personal Files/GitHub/IntroToDataViz/course/final'
...
find "$SITE_DIR" \( -iname '*.html' -o -iname '*.css' -o -iname '*.js' \) -exec gzip -9 -n {} \;
